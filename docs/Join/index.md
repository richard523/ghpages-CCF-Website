...
<!-- - <h3>__C++/Python Programmer__: <br/>We're seeking a skilled volunteer programmer with experience in C++ and/or Python to help develop, maintain, and improve our software projects and technical infrastructure. <br/><br/><a href="/Join/programmer-role">:octicons-arrow-right-24: View the full description here to apply</a></h3> -->
<!-- - <h3>__Volunteer Onboarding Specialist__: <br/>We need a proactive volunteer to specialize in the onboarding of new volunteers, focusing on training and integration into our team. <br/><br/><a href="/Join/volunteer-onboarding-specialist">:octicons-arrow-right-24: View the full description here to apply</a></h3> -->
<!-- - <h3>__Datacenter Administrator__: <br/>We are seeking a dedicated volunteer IT Administrator to help maintain and support our small datacenter operations. This role is crucial for ensuring the smooth functioning of our digital infrastructure that supports our research and educational initiatives. <br/><br/><a href="/Join/datacenter-admin-role">:octicons-arrow-right-24: View the full description here to apply</a></h3> -->
<!-- - <h3>__Volunteer Onboarding Coordinator__: <br/>We're looking for a detail-oriented volunteer to help coordinate the onboarding process for new volunteers, ensuring a smooth and welcoming experience. <br/><br/><a href="/Join/volunteer-onboarding-coordinator">:octicons-arrow-right-24: View the full description here to apply</a></h3> -->
...
<!-- - <h3>__Assistant Project Manager__: <br/>We're seeking a proactive and detail-oriented Assistant Project Manager to help coordinate and support the execution of research, engineering, and outreach projects across the Carboncopies Foundation. <br/><br/><a href="/Join/assistant-pm">:octicons-arrow-right-24: View the full description here to apply</a></h3> -->
...
<!-- Needs sprucing up [Click here to learn more about who we are and meet the people you’d be working with.](/About/Team/Us) -->
